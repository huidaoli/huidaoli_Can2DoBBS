...
import comcan2do.bbs.util.CookieStorage;
import comcan2do.bbs.util.ObjStorage;
import comcan2do.bbs.util.SimpleHASH;
...
public class Api {
	...
	public static final int SECURITY_FORUM_ID = 61; // 安全版块id
